const urlBase ='https://jsonplaceholder.typicode.com/posts' //url con la cual interactuamos

let posts = [] //iniciamos posteos con array vacio
...
function postData(){
    ...
    .then(res => res.json())
    .then(data => {
        // posts.push(data) // lo cambiamos por el unshift para que vengan ordenados
        posts.unshift(data) 
        renderPostList()
        postTitleInput.value = ''
        postBodyInput.value = ''
    })
    .catch(error => console.error('Error al querer crear postero: ', error))
